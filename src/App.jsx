            ...
            <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-6'>
              ...
              <div className='w-full'>
                ...
                <input
                  ...
                  }  text-gray-300 rounded-lg text-md block w-full p-2 file:bg-gray-600 file:border-0 file:text-gray-300 file:rounded-lg file:cursor-pointer file:mr-4 focus:outline-none focus:ring-2 focus:ring-indigo-500`}
                />
                {errors.paymentSS && (
                  <p className='text-red-500 text-sm mt-1'>
